...
/***/ function(module, exports) {
	...
	Elm.App.Model.make = function (_elm) {
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var initialModel = {messages: _U.list([]),pendingMessage: ""};
	   var Model = F2(function (a,b) {    return {messages: a,pendingMessage: b};});
	...
	Elm.App.Update.make = function (_elm) {
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var addMessage = F2(function (model,message) {    return _U.update(model,{messages: A2($Basics._op["++"],model.messages,_U.list([message]))});});
	   var sendMessageMailbox = $Signal.mailbox("");
	   var UpdatePendingMessage = function (a) {    return {ctor: "UpdatePendingMessage",_0: a};};
	   var MessageSent = {ctor: "MessageSent"};
	   var sendMessageToBeSent = function (message) {
	      return A2($Effects.map,function (_p0) {    return MessageSent;},$Effects.task(A2($Signal.send,sendMessageMailbox.address,message)));
	   };
	   var update = F2(function (action,model) {
	      var _p1 = action;
	      switch (_p1.ctor)
	      {case "NewMessage": return {ctor: "_Tuple2",_0: A2(addMessage,model,_p1._0),_1: $Effects.none};
	         case "SendMessage": return {ctor: "_Tuple2",_0: model,_1: sendMessageToBeSent(_p1._0)};
	         case "UpdatePendingMessage": return {ctor: "_Tuple2",_0: _U.update(model,{pendingMessage: _p1._0}),_1: $Effects.none};
	         default: return {ctor: "_Tuple2",_0: _U.update(model,{pendingMessage: ""}),_1: $Effects.none};}
	   });
	   var SendMessage = function (a) {    return {ctor: "SendMessage",_0: a};};
	   var NewMessage = function (a) {    return {ctor: "NewMessage",_0: a};};
	   ...
	   return _elm.App.Update.values = {_op: _op
	                                   ...
	                                   ,sendMessageMailbox: sendMessageMailbox
	                                   ,update: update
	                                   ,addMessage: addMessage
	                                   ,sendMessageToBeSent: sendMessageToBeSent};
	};
	Elm.App = Elm.App || {};
	...
	Elm.App.View.make = function (_elm) {
	   ...
	   $Signal = Elm.Signal.make(_elm);
	   var _op = {};
	   var newMessageForm = F2(function (address,model) {
	      return A2($Html.form,
	      ...
	      function (_p0) {
	         return A2($Signal.message,address,$App$Update.SendMessage(model.pendingMessage));
	      })]),
	      _U.list([A2($Html.input,
	              _U.list([$Html$Attributes.value(model.pendingMessage)
	                      ,A3($Html$Events.on,
	                      "input",
	                      $Html$Events.targetValue,
	                      function (_p1) {
	                         return A2($Signal.message,address,$App$Update.UpdatePendingMessage(_p1));
	                      })]),
	              _U.list([]))
	              ,A2($Html.button,_U.list([]),_U.list([$Html.text("Send")]))]));
	   });
	   var message = function (m) {    return A2($Html.div,_U.list([]),_U.list([$Html.text(m)]));};
	   var messages = function (model) {    return A2($Html.div,_U.list([]),A2($List.map,message,model.messages));};
	   var view = F2(function (address,model) {    return A2($Html.div,_U.list([]),_U.list([messages(model),A2(newMessageForm,address,model)]));});
	   return _elm.App.View.values = {_op: _op,view: view,messages: messages,message: message,newMessageForm: newMessageForm};
	};
	Elm.Main = Elm.Main || {};
	Elm.Main.make = function (_elm) {
	   ...
	   $Task = Elm.Task.make(_elm);
	   var _op = {};
	   var sendMessage = Elm.Native.Port.make(_elm).outboundSignal("sendMessage",function (v) {    return v;},$App$Update.sendMessageMailbox.signal);
	   var newMessage = Elm.Native.Port.make(_elm).inboundSignal("newMessage",
	   "String",
	   function (v) {
	   ...
	   var app = $StartApp.start({init: $App$Update.init
	                             ...
	                             ,inputs: _U.list([A2($Signal.map,$App$Update.NewMessage,newMessage)])});
